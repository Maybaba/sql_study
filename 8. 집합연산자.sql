...
-- 5. 성능이 나쁘다...?지가 알아서 다 하기 때문ㅇ ㅔ .. 부하가일어남

-- join 과 다르게 세로로 추가된다. 위아래로 합치는 것
SELECT
emp_no,
emp_nm,
birth_de
...
FROM tb_emp
WHERE birth_de BETWEEN '19600101' AND '19691231'
-- ORDER BY birth_de 정렬은 가각 넣을 수 없고 마지막에 한번만 넣어서 정렬해야 한다
-- 어떤 정렬을 기준으로 값을 낼지 정하지 못해서 오류 뜸
UNION ALL
SELECT
emp_no,
emp_nm,
